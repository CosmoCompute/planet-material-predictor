...
# Convert all properties
    ...
    elif predicted_label == "sedimentary_rocks":
        ig_model=keras.models.load_model("models/sedimentary_model.keras")
        ig_scaler=joblib.load("models/sedimentary_scaler.pkl")
        ig_le=joblib.load("models/sedimentary_label_encoder.pkl")
        rock_type, confidence, probabilities = predict_rock_type(
            ig_scaler, ig_model, ig_le,V_earth, A_earth, D_earth, f_earth
        )
    ...
    elif predicted_label == "ore_and_industrial_minerals":
        ig_model=keras.models.load_model("models/Ore and Industrial Minerals_model.keras")
        ig_scaler=joblib.load("models/Ore and Industrial Minerals_model_scaler.pkl")
        ig_le=joblib.load("models/Ore and Industrial Minerals_model_label_encoder.pkl")
        rock_type, confidence, probabilities = predict_rock_type(
            ig_scaler, ig_model, ig_le,V_earth, A_earth, D_earth, f_earth
        )
    ...
    elif predicted_label == "silicate_minerals":
        ig_model=keras.models.load_model("models/Silicate_model.keras")
        ig_scaler=joblib.load("models/Silicate_scaler.pkl")
        ig_le=joblib.load("models/Silicate_label_encoder.pkl")
        rock_type, confidence, probabilities = predict_rock_type(
            ig_scaler, ig_model, ig_le,V_earth, A_earth, D_earth, f_earth
        )
    ...
    elif predicted_label == "evaporites_and_soft_minerals":
        ig_model=keras.models.load_model("models/Evaporites and Soft Minerals_model.keras")
        ig_scaler=joblib.load("models/Evaporites and Soft Minerals_scaler.pkl")
        ig_le=joblib.load("models/Evaporites and Soft Minerals_label_encoder.pkl")
        rock_type, confidence, probabilities = predict_rock_type(
            ig_scaler, ig_model, ig_le,V_earth, A_earth, D_earth, f_earth
        )
    ...
    elif predicted_label == "gem_and_rare_minerals":
        ig_model=keras.models.load_model("models/Gem and Rare Minerals_model.keras")
        ig_scaler=joblib.load("models/Gem and Rare Minerals_scaler.pkl")
        ig_le=joblib.load("models/Gem and Rare Minerals_label_encoder.pkl")
        rock_type, confidence, probabilities = predict_rock_type(
            ig_scaler, ig_model, ig_le,V_earth, A_earth, D_earth, f_earth
        )
